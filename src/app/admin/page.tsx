...
import { collection, doc, updateDoc, query, orderBy, setDoc, limit, addDoc } from "firebase/firestore";
...
import { ShieldCheck, Edit2, Loader2, Save, X, Zap, Banknote, User, Copy, ShieldAlert, TrendingUp, Info, CreditCard, Plus, Utensils } from "lucide-react";
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-6xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
          <div>
            ...
            <p className="text-muted-foreground font-bold mt-2 uppercase text-[10px] tracking-widest">Admin Control Center</p>
          </div>
        </div>

        <Tabs defaultValue="payments" className="space-y-8">
          <TabsList className="bg-card p-1.5 rounded-[1.5rem] h-16 w-full md:w-auto shadow-sm border border-border/50">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full h-14 rounded-2xl bg-background border-2 border-border/50 px-4 font-bold"
                    >
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="h-14 rounded-2xl font-black bg-background border-2"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-8">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="bg-background px-4 py-2 rounded-xl flex items-center gap-4 border border-border/50 cursor-pointer mt-4" onClick={() => copyToClipboard(req.upiId)}>
